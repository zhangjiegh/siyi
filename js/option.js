...
var dayDiv3 = document.getElementById('dayDiv');
var dayDivChart3 = echarts.init(dayDiv3, null, {renderer: 'svg'});

var dayDiv4 = document.getElementById('dayDiv');
var dayDivChart4 = echarts.init(dayDiv4, null, {renderer: 'svg'});

var dayDiv5 = document.getElementById('dayDiv');
var dayDivChart5 = echarts.init(dayDiv5, null, {renderer: 'svg'});

var dayDiv6 = document.getElementById('dayDiv');
...
function getDay3() {
    ...
    if (option2 && typeof option2 === "object") {
        dayDivChart3.setOption(option2, true);
    }
}
function getDay4() {
    var rawData =[]
    ...
    if (option2 && typeof option2 === "object") {
        dayDivChart4.setOption(option2, true);
    }
}
function getDay5() {
    var rawData =[]
    ...
    if (option2 && typeof option2 === "object") {
        dayDivChart5.setOption(option2, true);
    }
}
function getDay6() {
    var rawData =[]
    ...
    if (option2 && typeof option2 === "object") {
        dayDivChart6.setOption(option2, true);
    }
}
function getDay7() {
    var rawData =[]
    ...
    if (option2 && typeof option2 === "object") {
        dayDivChart7.setOption(option2, true);
    }
}
function getDay8() {
    var rawData =[]
    ...
    if (option2 && typeof option2 === "object") {
        dayDivChart8.setOption(option2, true);
    }
}
function getDay9() {
    var rawData =[]
    ...
    if (option2 && typeof option2 === "object") {
        dayDivChart9.setOption(option2, true);
    }
}
